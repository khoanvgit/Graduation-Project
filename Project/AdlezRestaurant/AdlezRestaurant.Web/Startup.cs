...
namespace AdlezRestaurant.Web
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<IdentityUser> userManager, RMContext context)
        {
            ...
            DbInitializer.SeedUsers(userManager, context);
            context.SaveChanges();
        }
    }
}
